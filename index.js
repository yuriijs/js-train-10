...
function extendAndFreezeObject(obj1, obj2) {
  ...
  const addingProperties = Object.assign(obj1, obj2);
  Object.freeze(addingProperties);
  if (Object.isFrozen(addingProperties)) {
...
function filterObjectsByKey(arr, key) {
  ...
  const arrWithKey = arr.filter((obj) => obj.hasOwnProperty(key));
  return arrWithKey;
...
function getObjectValuesSum(obj) {
  ...
  const sumAllValuesObj = allValuesObj.reduce(
    (accumulator, currentValue) => accumulator + currentValue,
    0
  );
  return sumAllValuesObj;
